...
void ResourceManager::addResourceRef( Resource &resource  )
{
	// Increase reference count
	++resource._userRefCount;
}
...
void ResourceManager::releaseUnusedResources(int type)
{
	...
	if( !killList.empty() ) releaseUnusedResources(type);
}
