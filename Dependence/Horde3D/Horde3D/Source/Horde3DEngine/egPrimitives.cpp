...
//	for( uint32 i = 0; i < 6; ++i )
	{
		const Vec3f &n = _planes[0].normal;
		...
		if( _planes[0].distToPoint( positive ) > 0 ) return true;
	}
    
    {
		const Vec3f &n = _planes[1].normal;
		...
		if( _planes[1].distToPoint( positive ) > 0 ) return true;
	}
    
    {
		const Vec3f &n = _planes[2].normal;
		...
		if( _planes[2].distToPoint( positive ) > 0 ) return true;
	}
    
    {
		const Vec3f &n = _planes[3].normal;
		...
		if( _planes[3].distToPoint( positive ) > 0 ) return true;
	}
    
    {
		const Vec3f &n = _planes[4].normal;
		...
		if( _planes[4].distToPoint( positive ) > 0 ) return true;
	}
    
    {
		const Vec3f &n = _planes[5].normal;
		...
		if( _planes[5].distToPoint( positive ) > 0 ) return true;
	}
