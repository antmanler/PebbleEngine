...
struct SceneNodeFlags
{
	enum List
	{
		...
		NoRayQuery = 0x4,
		NoLighting= 0x8,
		Inactive = 0xf  // NoDraw | NoCastShadow | NoRayQuery
	};
};
...
public:
    ...
    const std::string &getTagString() {return _tag; }
    void setTagString( const char* tagData) { _tag = tagData; }
...
protected:
    ...
    std::string                 _tag;  // Short string for user defined data
