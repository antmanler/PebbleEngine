 ...
 */
class DLLEXP QSceneNode : public QXmlTreeNode
{
    Q_OBJECT
    ...
    Q_PROPERTY(QString Tag  READ tag  WRITE setTag  DESIGNABLE true USER true)
...
public:
    ...
    /**
          * Node tag attribute value
          * @return tag attribute of the current node
          */
    QString tag() const{return m_xmlNode.attribute("tag");}
