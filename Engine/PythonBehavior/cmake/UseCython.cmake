...
function( cython_add_standalone_library _name _generated)
  set( pyx_module_sources "" )
  set( pyx_sources "" )
  set( other_module_sources "" )
  include_directories( ${PYTHON_INCLUDE_DIRS} )
  ...
  add_library( ${_name} SHARED ${pyx_module_sources} ${pyx_sources} ${other_module_sources} )
  target_link_libraries( ${_name} ${PYTHON_LIBRARY} ${pyx_module_libs} )
  set(${_generated} ${pyx_module_sources} PARENT_SCOPE )
endfunction()
